 ...
 * « logo classique » du FoxLogo). Géométrie ET couleurs reprises À L'IDENTIQUE de
 * apps/web/app/icon.svg — on ne repeint pas la marque.
  ...
  return (
    ...
    >
      ...
      <polygon
        ...
        fill="#0B1417"
      />
      <polygon points="363,644 483,698 524,781 411,735" fill="#0B1417" />
      <polygon points="771,701 895,646 849,733 731,783" fill="#0B1417" />
      <polygon
