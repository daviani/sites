  ...
  return (
    <section className="mb-12">
      <Link href={`/${article.slug}`} className="block group">
        <article className="p-8 md:p-10 bg-gradient-to-br from-nord-10/10 via-transparent to-nord-9/5 dark:from-nord-10/20 dark:via-nord-3/50 dark:to-nord-9/10 backdrop-blur-md rounded-[2.5rem] border-l-4 border-nord-10 shadow-lg hover:shadow-xl transition-all duration-300">
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-nord-10 text-white rounded-full text-xs font-medium">
